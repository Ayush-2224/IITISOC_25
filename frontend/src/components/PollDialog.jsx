...
function PollDialog({ groupId, userId, onClose }) {
    ...
    const modalContent = (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">
            <div className="bg-white/5 backdrop-blur-xl border border-white/20 rounded-2xl p-6 w-full max-w-md shadow-2xl max-h-[90vh] flex flex-col">
                {/* Header */}
                ...
                {/* Button Row - always visible at bottom of modal */}
                <div className="flex space-x-3 pt-4 mt-4 border-t border-white/10 flex-shrink-0 bg-white/10 backdrop-blur-xl z-10">
                    <button
                        onClick={onClose}
                        disabled={isSubmitting}
